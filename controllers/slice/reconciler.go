...
//+kubebuilder:webhook:path=/mutate-appsv1-statefulset,mutating=true,failurePolicy=fail,groups="apps",resources=statefulsets,verbs=create;update,versions=v1,name=mstatefulset.kubeslice.io,admissionReviewVersions=v1,sideEffects=NoneOnDryRun
