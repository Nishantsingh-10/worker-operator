...
//+kubebuilder:webhook:path=/mutate-corev1-pod,mutating=true,failurePolicy=fail,groups="";apps,resources=pods;deployments;statefulsets,verbs=create;update,versions=v1,name=webhook.kubeslice.io,admissionReviewVersions=v1,sideEffects=NoneOnDryRun
